...
@Service
@RepeatServiceFor(type = RepeatType.ANNUALLY)
public class AnnuallyRepeatService extends RepeatService {
    @Autowired
    public AnnuallyRepeatService(TemplateService templateService, TemplateRepository templateRepository) {
